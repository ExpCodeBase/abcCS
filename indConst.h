...
extern void coreSkyComp(BiGraph& g);

extern int maxkcorenumber_test_optimal(BiGraph& g);

extern void skyIndexBasic(BiGraph& g, std::unordered_map<std::string, std::vector<std::vector<int>>>& skyLable);

extern void skyIndexDelta(BiGraph& g, std::unordered_map<std::string, std::vector<std::vector<int>>>& skyLable, int& delta);
